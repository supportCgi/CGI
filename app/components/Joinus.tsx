...
const Joinus = () => {
  return (
    <div className="timeline-end  text-center justify-center py-12 text-center py-6 md:py-10 bg-gradient-to-r from-blue-600 to-green-500 text-white  ">
        <div className='text-4xl md:text-6xl'>
            <h3 className='font-bold'>Rejoignez notre aventure numérique</h3>
        </div>
