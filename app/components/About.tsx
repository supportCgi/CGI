      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 h-full max-w-7xl w-full">
        ...
        >
          <Tilt options={tiltOptions}>
            <Image src="/images/grid/grid1.jpg" alt="Initiatives" className="w-full h-80 object-cover mb-4 rounded-t-lg" width={800} height={300} />
            <div className='p-6'>
        ...
        >
          <Tilt options={tiltOptions}>
            <Image src="/images/grid/grid2.jpg" alt="Image représentant nos partenaires et collaborations" className="w-full h-80 object-cover mb-4 rounded-t-lg" width={800} height={300} />
            <div className='p-6'>
        ...
        >
          <Tilt options={tiltOptions}>
            <Image src="/images/grid/grid3.jpg" alt="Education" className="w-full h-64 object-cover mb-4 rounded-t-lg" width={800} height={300} />
            <div className='p-6'>
        ...
        >
          <Tilt options={tiltOptions}>
            <Image src="/images/grid/grid3.jpg" alt="Mouvement" className="w-full h-80 object-cover mb-4 rounded-t-lg" width={800} height={300} />
            <div className='p-6'>
